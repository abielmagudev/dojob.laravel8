...
<div class="mb-3">
    ...
    <input type="number" step="1" min="0" class="form-control" id="inputSuccessfulInspections" name="successful_inspections" value="{{ old('successful_inspections', ($job->successful_inspections ?? 0)) }}">
</div>
@if( is_int($job->id) )
<p>Extensions</p>
